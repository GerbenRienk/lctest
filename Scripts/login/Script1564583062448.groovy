...
WebUI.navigateToUrl('https://tds-edc.com/lcw020')

WebUI.setText(findTestObject('Object Repository/Page_OpenClinica/input_User Name_j_username'), 'grvisser')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_OpenClinica/input_Password_j_password'), 'NxAzSABfFsnl/3PNQ5Q7pkr7/iQNSlnN')
