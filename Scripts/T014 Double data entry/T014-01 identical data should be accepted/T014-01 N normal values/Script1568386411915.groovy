...
def Subject_N = 'T014_N_' + Today1String
def Subject_N_Ev_A = 'T014_N_A_' + Today1String
def Subject_N_Ev_B1 = 'T014_N_B1_' + Today1String
def Subject_N_Ev_B2 = 'T014_N_B2_' + Today1String
...
WebUI.setText(findTestObject('Page_OpenClinica/input_Study Subject ID_label'), Subject_N)
...
// subject N event A
WebUI.setText(findTestObject('Page_OpenClinica/input_Support_findSubjects_f_studySubjectlabel'), Subject_N)
...
WebUI.selectOptionByValue(findTestObject('Page_OpenClinica/select_-Select-EV_A (Non-repeating)EV_B (Repeating)EV_C (Non-repeating)EV_D (Repeating)'), 
    EV_C_ID, true)
WebUI.setText(findTestObject('Page_OpenClinica/input_Location_location'), Subject_N_Ev_A)
...
WebUI.selectOptionByValue(findTestObject('Page_OpenClinica/select_-Select-EV_A (Non-repeating)EV_B (Repeating)EV_C (Non-repeating)EV_D (Repeating)'), 
    EV_D_ID, true)
WebUI.setText(findTestObject('Page_OpenClinica/input_Location_location'), Subject_N_Ev_B1)
WebUI.click(findTestObject('Page_OpenClinica/input_Leave this field blank if the end datetime is not applicable_Submit'))
WebUI.click(findTestObject('Page_OpenClinica/img_v1_bt_EnterData0'))
...
WebUI.selectOptionByValue(findTestObject('Page_OpenClinica/select_-Select-EV_A (Non-repeating)EV_B (Repeating)EV_C (Non-repeating)EV_D (Repeating)'), 
    EV_D_ID, true)
WebUI.setText(findTestObject('Page_OpenClinica/input_Location_location'), Subject_N_Ev_B2)
WebUI.click(findTestObject('Page_OpenClinica/input_Leave this field blank if the end datetime is not applicable_Submit'))
WebUI.click(findTestObject('Page_OpenClinica/img_v1_bt_EnterData0'))
...
WebUI.setText(findTestObject('Page_OpenClinica/input_Support_findSubjects_f_studySubjectlabel'), Subject_N)
WebUI.click(findTestObject('Page_OpenClinica/input_Support_navSearchButton'))
WebUI.setText(findTestObject('Page_OpenClinica/input_Page 1 of 1_ebl_filterKeyword'), Subject_N_Ev_A)
...
WebUI.setText(findTestObject('Page_OpenClinica/input_Support_findSubjects_f_studySubjectlabel'), Subject_N)
WebUI.click(findTestObject('Page_OpenClinica/input_Support_navSearchButton'))
WebUI.setText(findTestObject('Page_OpenClinica/input_Page 1 of 1_ebl_filterKeyword'), Subject_N_Ev_B1)
WebUI.click(findTestObject('Page_OpenClinica/input_Page 1 of 1_button_search'))
...
WebUI.setText(findTestObject('Page_OpenClinica/input_Support_findSubjects_f_studySubjectlabel'), Subject_N)
WebUI.click(findTestObject('Page_OpenClinica/input_Support_navSearchButton'))
WebUI.setText(findTestObject('Page_OpenClinica/input_Page 1 of 1_ebl_filterKeyword'), Subject_N_Ev_B2)
WebUI.click(findTestObject('Page_OpenClinica/input_Page 1 of 1_button_search'))
WebUI.click(findTestObject('Page_OpenClinica/img_v1_bt_EnterData1'))
